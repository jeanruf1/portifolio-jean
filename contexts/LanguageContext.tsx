...
const translations = {
  pt: {
    ...
    "hero.desc": "Profissional em orquestração de workflows, arquiteturas RAG e pipelines escaláveis. Foco no design e implementação de soluções automatizadas para embasar decisões corporativas de ponta a ponta.",
  ...
  en: {
    ...
    "hero.title1": "HI, I AM",
    "hero.title2": "JEAN RUFINO.",
    "hero.desc": "Professional in workflow orchestration, RAG architectures, and scalable pipelines. Focused on designing and implementing automated solutions to drive corporate decisions end-to-end.",
